...
export default async function Home() {
  ...
  const content = await getPublishedContentPage("home");
          ...
          <div className="relative overflow-hidden rounded-3xl bg-blue-50 min-h-[680px] flex flex-col items-center">
            ...
            <div className="relative z-10 flex flex-col items-center gap-8 px-6 pt-5 max-w-[1111px] text-center">
              ...
              <div className="flex items-center gap-[15px] flex-wrap justify-center">
                ...
                <Link href={content.secondaryButtonHref} className="flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-black/20 bg-white text-gray-800 font-inter text-base font-bold leading-6 hover:border-black/40 transition-colors">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <img src={content.heroImage} className="mt-[40px] md:hidden z-2" alt="Image" />
            ...
            <div className="hero-mockup-area sm:flex hidden">
              ...
              {/* Phone mockup */}
              <Image src={content.heroMockupImage} height={500} width={500} className="w-[400px] h-[410px] z-2" alt="Image" />

              {/* Anonymous Report floating card */}
              <div className="anon-report-card">
                <span className="anon-report-card__label">{content.heroAnonymousLabel}</span>
                <div className="anon-report-card__badge">
                  <span className="anon-report-card__badge-text">{content.heroStatusLabel}</span>
              ...
              <div className="review-card">
                <div className="review-card__header">
                  <div className="review-card__school-info">
                    <span className="review-card__school-name">{content.heroReviewSchool}</span>
                    <span className="review-card__school-type">{content.heroReviewSchoolType}</span>
                  </div>
                  <div className="review-card__rating-badge">{content.heroReviewRating}</div>
                </div>
                <div className="review-card__body">
                  ...
                  <div className="review-card__footer">
                    <div className="review-card__verified">
                      ...
                      <span>{content.verifiedUserLabel}</span>
                    </div>
                    <span className="review-card__timestamp">{content.heroReviewTime}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="bg-white px-6 sm:pb-[72px] pb-0 pt-[72px] flex flex-col items-center gap-12">
          ...
          <div className="flex sm:flex-row flex-col sm:items-start items-center justify-center w-full max-w-[1200px] gap-[40px] sm:gap-0">
            ...
            <div className="flex flex-col items-center gap-2 flex-1 px-4 min-w-0">
              <Image src={content.whyStayAnonymousImage} height={100} width={100} className="w-[70px] h-[70px]" alt="Icon" />
              <h3 className="text-gray-800 text-center font-[Outfit] text-2xl font-semibold leading-8">{content.whyStayAnonymousHeading}</h3>
              <div className="text-gray-800 text-center font-inter text-base font-normal leading-[26px] px-12"><RichContent content={content.whyStayAnonymousDescription} /></div>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 flex-1 px-4 min-w-0">
              <div className="relative w-20 h-[70px] flex items-center justify-center">
                <Image src={content.whyStructuredReportsImage} height={100} width={100} className="w-[60px] h-[60px]" alt="Icon" />
              </div>
              <h3 className="text-gray-800 text-center font-[Outfit] text-2xl font-semibold leading-8">{content.whyStructuredReportsHeading}</h3>
              <div className="text-gray-800 text-center font-inter text-base font-normal leading-[26px] px-12"><RichContent content={content.whyStructuredReportsDescription} /></div>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 flex-1 px-4 min-w-0">
              <div className="relative w-20 h-[70px]">
                <Image src={content.whyBetterDecisionsImage} height={100} width={100} className="w-[70px] h-[70px]" alt="Icon" />
              </div>
              <h3 className="text-gray-800 text-center font-[Outfit] text-2xl font-semibold leading-8">{content.whyBetterDecisionsHeading}</h3>
              <div className="text-gray-800 text-center font-inter text-base font-normal leading-[26px] px-12"><RichContent content={content.whyBetterDecisionsDescription} /></div>
            </div>
          </div>
          ...
          <div className="flex sm:flex-row flex-col sm:items-start items-center justify-center w-full max-w-[1200px] gap-[40px] sm:gap-0">
            ...
            <div className="flex flex-col items-center gap-2 flex-1 px-4 min-w-0">
              <Image src={content.whySmartSearchImage} height={100} width={100} className="w-[70px] h-[70px]" alt="Icon" />

              <h3 className="text-gray-800 text-center font-[Outfit] text-2xl font-semibold leading-8">{content.whySmartSearchHeading}</h3>
              <div className="text-gray-800 text-center font-inter text-base font-normal leading-[26px] px-12"><RichContent content={content.whySmartSearchDescription} /></div>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 flex-1 px-4 min-w-0">
              <div className="relative w-20 h-[70px] flex items-center justify-center">
                <Image src={content.whyAiInsightsImage} height={100} width={100} className="w-[70px] h-[70px]" alt="Icon" />

              </div>
              <h3 className="text-gray-800 text-center font-[Outfit] text-2xl font-semibold leading-8">{content.whyAiInsightsHeading}</h3>
              <div className="text-gray-800 text-center font-inter text-base font-normal leading-[26px] px-12"><RichContent content={content.whyAiInsightsDescription} /></div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-[1176px] mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            ...
            <div className="sm:order-1 order-2 relative flex w-full lg:max-w-[534px] lg:flex-shrink-0 rounded-[32px] bg-[#F8F9FD] overflow-hidden lg:aspect-[534/396] aspect-auto min-h-[400px] lg:min-h-auto">
              ...
              <div className="absolute left-[5.6%] top-[7.6%] w-[72.3%] h-[84.8%] bg-white rounded-2xl shadow-[0_4px_36px_0_rgba(1,113,249,0.06)]">
                <p className="absolute left-5 top-5 font-inter text-base font-medium text-black leading-[26px]">{content.understandProfileLabel}</p>
              ...
              <div className="absolute lg:top-[19.7%] lg:left-[57%] top-[19%] right-[8%] flex items-center gap-2.5 pl-1.5 pr-4 py-1.5 bg-white rounded-full border border-[#F9F9F9] shadow-[0_10px_50px_-12px_rgba(0,0,0,0.16)] backdrop-blur-[5px]">
                ...
                <span className="font-inter sm:text-sm text-xs font-medium text-[#191C1D] whitespace-nowrap">{content.understandRiskBadge}</span>
              </div>
              ...
              <div className="absolute lg:top-[39.1%] lg:left-[50.6%] top-[35%] right-[8px] flex items-center gap-2.5 pl-1.5 pr-4 py-1.5 bg-white rounded-full border border-[#F9F9F9] shadow-[0_10px_50px_-12px_rgba(0,0,0,0.16)] backdrop-blur-[5px]">
                ...
                <span className="font-inter sm:text-sm text-xs font-medium text-[#191C1D] whitespace-nowrap">{content.understandPatternBadge}</span>
              </div>
              ...
              <div className="absolute lg:top-[57.6%] lg:left-[55.8%] top-[51%] right-[2%] flex items-center gap-2.5 pl-1.5 pr-4 py-1.5 bg-white rounded-full border border-[#F9F9F9] shadow-[0_10px_50px_-12px_rgba(0,0,0,0.16)] backdrop-blur-[5px]">
                ...
                <span className="font-inter sm:text-sm text-xs font-medium text-[#191C1D] whitespace-nowrap">{content.understandHistoryBadge}</span>
              </div>
            </div>
            ...
            <div className="sm:order-2 order-1 flex flex-col gap-7 flex-1 lg:max-w-[522px] w-full">
              <h2 className="font-[Outfit] sm:text-[clamp(28px,3.8vw,44px)] font-semibold text-[#121212] leading-[1.32] text-[clamp(20px,3.8vw,44px)]">
                {content.understandHeading}
              </h2>
              <div className="font-inter sm:text-base text-[#212121] leading-[26px] opacity-[0.96] text-[15px]">
                <RichContent content={content.understandDescription} />
              </div>
            </div>
        ...
        <section className="bg-white px-6 sm:pb-[72px] pb-0 pt-[72px]">
          ...
          <div className="flex  max-w-[1176px] mx-auto flex-col lg:flex-row items-center gap-10 lg:gap-16">
            ...
            <div className="flex flex-col gap-7 flex-1 max-w-[522px]">
              ...
              <div className="font-inter sm:text-base text-[#212121] leading-[26px] opacity-[0.96] text-[15px]">
                <RichContent content={content.opportunitiesDescription} />
              </div>
            </div>
            <img src={content.opportunitiesImage} alt="Image" className="sm:hidden w-full h-auto" />
            ...
            <div className="relative sm:block hidden w-full max-w-[534px] flex-shrink-0 rounded-[32px] bg-[#F8F9FD] overflow-hidden aspect-[534/396]">
              ...
              >
                ...
                <span className="font-inter text-sm text-[rgba(115,119,134,0.6)]">{content.opportunitiesSearchPlaceholder}</span>
              </div>
              ...
              >
                ...
                >
                  {content.opportunitiesInsightsLabel}
                </span>
                <div className="absolute flex items-center gap-3" style={{ left: '20px', top: '56px' }}>
                  ...
                  <div className="flex items-center gap-1.5 rounded-[10px] bg-[rgba(47,175,0,0.20)] px-2 py-1.5">
                    ...
                    <span className="font-inter font-medium text-[#2FAF00]" style={{ fontSize: '14px', lineHeight: '18px' }}>{content.opportunitiesPositiveLabel}</span>
                  </div>
                  {/* Negative badge */}
                  <div className="flex items-center gap-1.5 rounded-[10px] bg-[rgba(255,0,0,0.20)] px-2 py-1.5">
                    ...
                    <span className="font-inter font-medium text-[#F32121]" style={{ fontSize: '14px', lineHeight: '18px' }}>{content.opportunitiesNegativeLabel}</span>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <span className="font-inter font-medium text-[#191C1D] whitespace-nowrap" style={{ fontSize: '14px', lineHeight: '18px' }}>{content.opportunitiesFilterLabel}</span>
              </div>
          ...
          <div className="max-w-[1176px] mx-auto flex flex-col items-center gap-12">
            ...
            <div className="w-full flex flex-col md:flex-row justify-center items-center">
              ...
              <div className="flex flex-col gap-5 flex-1 px-6 py-2 md:py-0 items-center">
                <Image src={content.stepsOneImage} height={100} width={100} className="w-[50px] h-[50px]" alt="Icon" />

                <h3 className="font-[Outfit] sm:text-[22px] text-[18px] font-bold text-gray-950 leading-[1.3]">
                  {content.stepsOneHeading}
                </h3>
                <div className="font-inter sm:text-base text-[15px] font-normal text-center text-gray-700 leading-[26px] text-center">
                  <RichContent content={content.stepsOneDescription} />
                </div>
              </div>
              ...
              {/* Step 2 */}
              <div className="flex flex-col gap-5 flex-1 px-6 py-2 md:py-0 items-center">
                <Image src={content.stepsTwoImage} height={100} width={100} className="w-[50px] h-[50px]" alt="Icon" />
                <h3 className="font-[Outfit] sm:text-[22px] text-[18px] font-bold text-gray-950 leading-[1.3]">
                  {content.stepsTwoHeading}
                </h3>
                <div className="font-inter sm:text-base text-[15px] font-normal text-gray-700 leading-[26px] text-center">
                  <RichContent content={content.stepsTwoDescription} />
                </div>
              </div>
              ...
              {/* Step 3 */}
              <div className="flex flex-col gap-5 flex-1 px-6 py-2 md:py-0  items-center">
                <Image src={content.stepsThreeImage} height={100} width={100} className="w-[50px] h-[50px]" alt="Icon" />
                <h3 className="font-[Outfit] sm:text-[22px] text-[18px] font-bold text-gray-950 leading-[1.3]">
                  {content.stepsThreeHeading}
                </h3>
                <div className="font-inter sm:text-base text-[15px] font-normal text-gray-700 leading-[26px] text-center">
                  <RichContent content={content.stepsThreeDescription} />
                </div>
              </div>
            ...
            <div className="rounded-[28px] bg-[#F8F9FD] sm:p-14 px-4 pt-10 flex flex-col lg:flex-row justify-between gap-10 lg:gap-16">
              ...
              <div className="flex flex-col justify-between gap-10 flex-shrink-0 lg:w-[556px]">
                <div className="flex flex-col sm:gap-8 gap-4">
                  ...
                  <div className="font-inter sm:text-base text-[15px] text-[#212121] leading-[26px] opacity-[0.96] max-w-[492px]">
                    <RichContent content={content.featureDescription} />
                  </div>
                </div>
                <div className="flex items-start gap-12">
                  <div className="flex flex-col gap-5">
                    ...
                    <span className="font-inter text-base text-[#212121] leading-[26px] tracking-[1px] uppercase opacity-80">{content.reportsLabel}</span>
                  </div>
                  <div className="flex flex-col gap-5">
                    <span className="font-[Outfit] sm:text-5xl text-3xl font-semibold text-[#121212] opacity-[0.96]">{formatCount(totalSchools)}</span>
                    <span className="font-inter text-base text-[#212121] leading-[26px] tracking-[1px] uppercase opacity-80">{content.schoolsLabel}</span>
                  </div>
                </div>
              </div>
